...
export const PromptGroupIcon = ({ size = 20, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className={iconClassName(className)}>
    <rect x="3" y="3" width="18" height="18" rx="3" />
    <rect x="6.5" y="6.5" width="4" height="4" rx="0.6" fill="currentColor" stroke="none" />
    <rect x="13.5" y="6.5" width="4" height="4" rx="0.6" fill="currentColor" stroke="none" />
    <rect x="6.5" y="13.5" width="4" height="4" rx="0.6" fill="currentColor" stroke="none" />
    <rect x="13.5" y="13.5" width="4" height="4" rx="0.6" fill="currentColor" stroke="none" />
  </svg>
);
